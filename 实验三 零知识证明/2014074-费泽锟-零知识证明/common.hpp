...
// transfer to x(x+2)(x-3)+(x-3)(x+10)=0
pb.val(out)=0;
...
// modified
// x+2= w_1
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(x + 2, 1, w_1));
// x-3= w_2
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(x - 3, 1, w_2));
// x+10= w_3
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(x + 10, 1, w_3));
// x*w_1=w_4
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(x, w_1, w_4));
// w_2*w_4=w_5
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_2, w_4, w_5));
// w_2*w_3=w_6
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_2, w_3, w_6));
// w_5+w_6=out
pb.add_r1cs_constraint(r1cs_constraint<FieldT>(w_5 + w_6, 1, out));
